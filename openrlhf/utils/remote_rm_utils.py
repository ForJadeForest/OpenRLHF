...
def remote_rm_fn(api_url, queries, answers=None, score_key="rewards"):
    ...
    """
    scores = request_api_wrapper(api_url, {"query": queries, "answers": answers}, score_key)
    return torch.tensor(scores)


@ray.remote
def remote_rm_fn_ray(api_url, queries, answers=None, score_key="rewards"):
    return remote_rm_fn(api_url, queries, answers, score_key)
